      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="text-center">
          ...
          <h2 className="mt-6 text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl lg:text-5xl">
            Reserve Your Stadium Time in 4 Easy Steps
          </h2>
          <p className="mx-auto mt-4 max-w-2xl text-lg font-normal text-gray-700 lg:text-xl lg:leading-8">
            Follow these steps to reserve hours to play football with your friends at our top-notch stadium.
          </p>
        </div>
        <ul className="mx-auto mt-12 grid max-w-md grid-cols-1 gap-10 sm:mt-16 lg:mt-20 lg:max-w-5xl lg:grid-cols-4">
          <li className="flex-start group relative flex lg:flex-col">
            ...
            <div className="ml-6 lg:ml-0 lg:mt-10">
              ...
              <h4 className="mt-2 text-base text-gray-700">Find the best stadium in your area. Use the search feature to quickly locate available stadiums.</h4>
              <span className="absolute text-sm text-gray-500 -top-5 left-2 whitespace-nowrap">Step: 1</span>
            </div>
          </li>
          <li className="flex-start group relative flex lg:flex-col">
            <span
            ...
            <div className="ml-6 lg:ml-0 lg:mt-10">
              ...
              <h4 className="mt-2 text-base text-gray-700">Choose your preferred time slot and make a reservation to secure the stadium for your event.</h4>
              <span className="absolute text-sm text-gray-500 -top-5 left-2 whitespace-nowrap">Step: 2</span>
            </div>
          </li>
          <li className="flex-start group relative flex lg:flex-col">
            <span
            ...
            <div className="ml-6 lg:ml-0 lg:mt-10">
              ...
              <h4 className="mt-2 text-base text-gray-700">Receive a confirmation of your reservation. Make sure to review the details and prepare accordingly.</h4>
              <span className="absolute text-sm text-gray-500 -top-5 left-2 whitespace-nowrap">Step: 3</span>
            </div>
          </li>
          <li className="flex-start group relative flex lg:flex-col">
            <div
            ...
            <div className="ml-6 lg:ml-0 lg:mt-10">
              ...
              <h4 className="mt-2 text-base text-gray-700">Arrive at the stadium and enjoy your time. Make the most out of the facilities and have fun!</h4>
              <span className="absolute text-sm text-gray-500 -top-5 left-2 whitespace-nowrap">Step: 4</span>
            </div>
          </li>
        </ul>
      </div>
